...
class Transformer(ForcastBaseModel):
    ...
    def forward(self, input_dict):
        ...
        if self.feature_type == "semantics" and not self.use_tfidf:
            # sum the token embeddings in the sequence
            x = x.sum(dim=-2)
        ...
        return_dict = {"loss" : loss, "y_pred": y_pred, "y": y}
